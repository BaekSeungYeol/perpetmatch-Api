...
operation::mypage-profile[snippets='path-parameters,response-fields,http-request,http-response']
...
operation::mypage-orders[snippets='path-parameters,response-fields,http-request,http-response']
