package com.perpetmatch.AdoptBoard.application;
...
import com.perpetmatch.AdoptBoard.domain.BoardMapper;
...
public class BoardService {
    ...
    public Board createNewBoard(Long id, BoardPostRequest boardRequest) {
        User member = userRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Board", "id", id));
